...
namespace ModbusCore
{
    public class ModbusUtilityTests
    {
        ...
        [InlineData(new byte[] { 0x01, 0x04, 0x00, 0x03, 0x00, 0x01 }, 0xCAC1)]
        [InlineData(new byte[] { 0x01, 0x04, 0x02, 0xFF, 0xFF }, 0x80B8)]
        [InlineData(new byte[] { 0x02, 0x04, 0x00, 0x03, 0x00, 0x01 }, 0xF9C1)]
        [InlineData(new byte[] { 0x02, 0x04, 0x02, 0x7F, 0x58 }, 0xFADC)]
